...
function initializePageSpecificFeatures() {
  ...
  if (typeof openPopup !== 'function') {
    console.log('Making popup functions globally available');
    // These functions should be defined in cart-manager.js
    window.openPopup = window.openPopup || function(product) {
      console.log('Global openPopup fallback called');
