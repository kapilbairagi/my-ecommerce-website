...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (dropdownList && topIndicator && bottomIndicator) {
    const updateIndicators = () => {
      topIndicator.style.opacity = dropdownList.scrollTop > 0 ? '1' : '0';
      bottomIndicator.style.opacity =
        dropdownList.scrollTop + dropdownList.clientHeight < dropdownList.scrollHeight ? '1' : '0';
    };
