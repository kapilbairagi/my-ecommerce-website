...
function openPopup(product) {
  ...
  // Update popup content with proper element targeting
  ...
  document.getElementById("popup-brand").textContent = product.brand || "Nike";
  ...
  if (product.oldPrice && product.oldPrice > product.price) {
    ...
    // Hide old price and discount if not applicable
    oldPriceEl.style.display = 'none';
    discountEl.style.display = 'none';
  }
  
  document.getElementById("popup-desc").textContent = product.description || "Lorem ipsum, dolor sit amet consectetur adipisicing elit...";
  ...
  // Handle the confirm button based on whether it's from wishlist or not
  ...
  const oldPriceText = card.querySelector('.old__price')?.textContent || "";
  ...
  return {
    ...
    oldPrice: oldPrice,
    img: card.querySelector(".product__images img")?.src || "assets/img/default.jpg",
    category: card.querySelector(".product__category")?.textContent.trim() || "Clothing",
    brand: "Nike", // You might want to extract this from your product data
