...
/*=============== COMPLETELY FIXED CATEGORIES DROPDOWN ===============*/
function categoriesDropdown() {
  ...
  if (dropdownToggle && dropdownList) {
    ...
    let overlay = document.querySelector('.categories-dropdown__overlay');
    if (!overlay) {
    ...
    // SIMPLE click event - no complex touch handling
    ...
    overlay.addEventListener('click', closeCategoriesDropdown);
