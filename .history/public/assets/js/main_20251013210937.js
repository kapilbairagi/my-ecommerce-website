...
document.querySelectorAll('.cart__btn').forEach(button => {
  button.addEventListener('click', function(e) {
    ...
    const productCard = this.closest('.product__item');
    if (!productCard) {
      console.log('No product card found'); // Debug line
      return;
    }
    ...
    // Use the popup functionality
    if (window.openPopup) {
      console.log('openPopup function found'); // Debug line
      window.openPopup(productData);
    } else if (typeof openPopup === 'function') {
      console.log('openPopup function found (alternative)'); // Debug line
      openPopup(productData);
    } else {
      console.log('openPopup function NOT found'); // Debug line
      console.log('window.openPopup:', window.openPopup); // Debug line
    }
  });
});