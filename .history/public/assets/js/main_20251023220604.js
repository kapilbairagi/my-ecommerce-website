...
function initializePageSpecificFeatures() {
  ...
  if (typeof openPopup !== 'function' && typeof window.openPopup !== 'function') {
    ...
    // The cart-manager.js should have already made openPopup available via window.openPopup
  }
  ...
  if (document.querySelector('.wishlist')) {
    ...
    if (typeof initializeWishlist === 'function') {
      // Force reinitialization with delay to ensure DOM is ready
      setTimeout(() => {
        initializeWishlist();
      }, 200);
    } else {
            ...
            <tr>
                <td colspan="3" style="text-align: center; padding: 40px;">
                    <div class="empty-cart">
                        ...
                        <p class="empty-cart__description">Please add some items to your cart before proceeding to checkout.</p>
