...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // handle overlay + outside clicks
const dropdownToggle = document.getElementById("categoriesDropdownButton");
  const dropdownList = document.querySelector(".categories-dropdown__list");
  const overlay = document.getElementById("categoriesDropdownOverlay");
